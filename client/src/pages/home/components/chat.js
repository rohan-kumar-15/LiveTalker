...
function ChatArea({ socket }){
  ...
  <div 
    style={{
      position: 'absolute',        // Overlay over existing content
      bottom: '60px',              // Adjust according to input box height
      right: '20px',               // Align to right side
      zIndex: 1000,                // Make sure it's on top
      boxShadow: '0 0 10px rgba(0,0,0,0.2)' // Optional: visual separation
    }}
  >
    <EmojiPicker 
